...
namespace WCS\FlyaroundBundle\Command;
...
class FlyaroundUserCommand extends ContainerAwareCommand
{
    protected function configure()
    {
        $this
            ->setName('wcs:flyaround:users')
            ->setDescription('Add flyaround users')
