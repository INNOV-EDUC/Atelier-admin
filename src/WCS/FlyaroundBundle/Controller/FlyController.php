...
use WCS\FlyaroundBundle\Entity\Fly;
use WCS\FlyaroundBundle\Form\FlyType;
...
class FlyController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('WCSFlyaroundBundle:Fly')->findAll();

        return $this->render('WCSFlyaroundBundle:Fly:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('WCSFlyaroundBundle:Fly:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('WCSFlyaroundBundle:Fly')->find($id);
        ...
        return $this->render('WCSFlyaroundBundle:Fly:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('WCSFlyaroundBundle:Fly:edit.html.twig', array(
            'entity'      => $entity,
